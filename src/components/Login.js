...
function Login() {
    ...
    return (
        ...
        <input type="email" name="mail" className="form-control-lg" value={userLogin.mail} onChange={loginMe} placeholder="Email Id" required/></div>
        <div className="form-group d-flex flex-column g-2">
        ...
        <hr/>
         <span>Don't have an account?  |   <Link to="/register">Click Register</Link></span> 
      </form>
      </>
    )
}
